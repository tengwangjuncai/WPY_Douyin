...
// 图片保存成功提示文字
#define SDPhotoBrowserSaveImageSuccessText MYLocalizedString(@"PAYORDER_SAVEPHOTO", nil);

// 图片保存失败提示文字
#define SDPhotoBrowserSaveImageFailText MYLocalizedString(@"SAVEPHOTO_FAILD", nil);
