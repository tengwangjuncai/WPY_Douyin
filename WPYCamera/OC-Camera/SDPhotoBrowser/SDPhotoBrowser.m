...
- (void)setupToolbars
{
    ...
    indexLabel.bounds = CGRectMake(0, [UIScreen mainScreen].bounds.size.width - 50,[UIScreen mainScreen].bounds.size.height, 30);
...
//    // 2.保存按钮
//    UIButton *saveButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 48, 24)];
//    [saveButton setTitle:MYLocalizedString(@"SAVEPHOTO", nil) forState:UIControlStateNormal];
//    [saveButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
//    saveButton.titleLabel.font = Font(12);
//    saveButton.backgroundColor = [UIColor colorWithWhite:0 alpha:0.1];
...
- (void)layoutSubviews
{
    ...
    _saveButton.center = CGPointMake(self.bounds.size.width * 0.9, self.bounds.size.height - 30);
}
